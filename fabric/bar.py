...
class StatusBar(Window):
    def __init__(
        ...
        self.progress_bars_overlay = Overlay(
            ...
            overlays=[
                ...
                Label("🖥️", style="margin: 0px 0px 0px 0px; font-size: 12px"),
            ],
        )
    ...
    #     is_visible = self.side_panel.get_visible()
    #     self.side_panel.set_visible(not is_visible)


if __name__ == "__main__":
    bar = StatusBar()
    app = Application("bar", bar)
    app.set_stylesheet_from_file(get_relative_path("./style/bar.css"))
